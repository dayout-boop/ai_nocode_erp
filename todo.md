...
- [ ] D1: DepartureDateCalendar PC에서 2개월 동시 표시
- [ ] D2: 행사 선택 카드 UI (dogolf.com 방식 - 예약가능/마감 뱃지 + 잔여인원)
- [ ] D3: 성인/아동/유아 인원 선택 +-버튼 + 총금액 계산
- [ ] D4: 상품 상세 탭 메뉴 (상품정보 / 여행일정 / 약관/환불규정)
- [ ] D5: 상품 검색 기능 (헤더 검색창)
- [ ] D6: 찜하기 기능 (상품 카드 + 상세 페이지)
- [ ] D7: ERP 슬롯 달력 시각화 뷰
